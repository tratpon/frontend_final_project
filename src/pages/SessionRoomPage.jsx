        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-6 space-y-2 sm:space-y-3">
            ...
            {messages.map((msg, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`px-3 py-2 rounded-xl max-w-[75%] text-sm whitespace-pre-line ${
                      isMine
          ...
          {roomInfo?.RoomStatus === "active" && (
            <div className="p-3 sm:p-4 bg-gray-100">
              <div className="flex items-end gap-2 sm:gap-4 bg-white rounded-2xl px-4 py-2">
